...
import de.rwth.idsg.steve.web.ApiLoggingFilter;
...
public class SecurityConfiguration {
        ...
        public SecurityFilterChain apiKeyFilterChain(HttpSecurity http,
                ...
                return http.securityMatcher(CONFIG.getApiMapping() + "/**")
                                ...
                                .addFilterBefore(new ApiLoggingFilter(), UsernamePasswordAuthenticationFilter.class)
                                .addFilter(new BasicAuthenticationFilter(apiAuthenticationManager,
